...
#footnote[
  На раздаточных материалах и в конце презентации будет #link("https://forms.gle/HDeC3Ekf9xCF7U1Q9")[форма обратной] связи. Ваши отзывы важны для нас и для площадки, чтобы делать следующие встречи лучше.
]
...
- По технологии: Java, .NET, Go, JS и другие.
...
Пример работы с AI по TDD будет в #link("https://github.com/QwenLM/qwen-code")[qwen-code]
на базе прошлой задачи-примера @example-task.
